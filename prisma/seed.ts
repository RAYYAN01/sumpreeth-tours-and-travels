...
async function main() {
  ...
  const destinations: DestSeed[] = [
    ...
    // Tier 2 — additional Karnataka towns with genuine standalone content,
    // picked from the district/taluk coverage list for real tourist or
    // commercial (airport/heritage/adventure) relevance, not name-swapping.
    { name: "Devanahalli", category: "HERITAGE", state: "KARNATAKA", description: "Historic fort town and the closest major landmark to Kempegowda International Airport.", distanceKm: 35, highlights: ["Birthplace of Tipu Sultan, inside a well-preserved fort", "Closest major town to Kempegowda International Airport", "Venkataramanaswamy Temple within the fort walls"] },
    { name: "Ramanagara", category: "OUTSTATION_GETAWAY", state: "KARNATAKA", description: "Rocky granite hills made famous as the shooting location of the film Sholay, and Karnataka's silk trading hub.", distanceKm: 50, highlights: ["Iconic rocky hills where Sholay was filmed", "One of Asia's largest silk cocoon markets", "Popular rock-climbing and rappelling spot"] },
    { name: "Kolar Gold Fields", category: "HERITAGE", state: "KARNATAKA", description: "A historic gold-mining town once home to some of the world's deepest mines, and the real-life backdrop referenced in the KGF films.", distanceKm: 100, highlights: ["Historic gold mines, among the world's deepest in their time", "Backdrop referenced in the KGF films", "Colonial-era mining architecture and Kolaramma Temple"] },
    { name: "Jog Falls", category: "NATURE_FALLS", state: "KARNATAKA", description: "India's second-highest plunge waterfall, where the Sharavathi river drops in four distinct cascades.", distanceKm: 380, highlights: ["Four named cascades — Raja, Rani, Rocket and Roarer", "Among India's highest plunge waterfalls", "Viewpoints and a seasonal trek to the base"] },
    { name: "Dandeli", category: "OUTSTATION_GETAWAY", state: "KARNATAKA", description: "Karnataka's adventure-tourism hub on the Kali river, known for white-water rafting and its wildlife sanctuary.", distanceKm: 460, highlights: ["White-water rafting on the Kali river", "Dandeli Wildlife Sanctuary — hornbills and black panthers", "Kayaking, zip-lining and night safaris"] },
    { name: "Belur", category: "HERITAGE", state: "KARNATAKA", description: "Home to the Chennakeshava Temple, one of the finest surviving examples of Hoysala architecture.", distanceKm: 220, highlights: ["Chennakeshava Temple, built in 1117 AD", "Intricately carved pillars and bracket figures", "Twin heritage town with nearby Halebeedu"] },
    { name: "Malpe", category: "OUTSTATION_GETAWAY", state: "KARNATAKA", description: "One of coastal Karnataka's most popular beaches, and the boat point for St. Mary's Island.", distanceKm: 420, highlights: ["Malpe Beach, a popular coastal Karnataka getaway", "Boat access to St. Mary's Island's hexagonal basalt rocks", "Working fishing harbour with fresh seafood"] },
    { name: "Manipal", category: "OUTSTATION_GETAWAY", state: "KARNATAKA", description: "A major university town on the coast, known for its End Point viewpoint and lakeside campus setting.", distanceKm: 415, highlights: ["End Point viewpoint over the Western Ghats and coast", "Manipal Lake and the Museum of Anatomy & Pathology", "Close to Malpe beach and Udupi's temple town"] },
    { name: "Kemmangundi", category: "HILL_STATION", state: "KARNATAKA", description: "A cool Western Ghats hill resort once used as a retreat by the Mysore royal family.", distanceKm: 270, highlights: ["Z Point viewpoint over the Western Ghats", "Rock Garden and nearby Hebbe Falls", "Once the Mysore royal family's hill retreat"] },
    { name: "Gokak Falls", category: "NATURE_FALLS", state: "KARNATAKA", description: "A horseshoe-shaped waterfall on the Ghataprabha river, often compared in shape to Niagara Falls.", distanceKm: 480, highlights: ["Horseshoe-shaped falls on the Ghataprabha river", "A historic hanging bridge across the gorge", "Nearby colonial-era cotton mill ruins"] },
    { name: "Bidar", category: "HERITAGE", state: "KARNATAKA", description: "A North Karnataka heritage city with Persian-influenced Bahmani architecture and the Bidriware metal-craft tradition.", distanceKm: 700, highlights: ["Bidar Fort's Persian-influenced Bahmani architecture", "Home of the Bidriware metal-inlay craft tradition", "Guru Nanak Jhira Sahib gurdwara"] },
    { name: "Kalaburagi", category: "HERITAGE", state: "KARNATAKA", description: "A historic Deccan city built around Gulbarga Fort and the Khwaja Bande Nawaz Dargah, a major Sufi pilgrimage site.", distanceKm: 615, highlights: ["Gulbarga Fort with over a dozen watchtowers", "Khwaja Bande Nawaz Dargah, a major Sufi shrine", "Jama Masjid, modelled on Cordoba's Great Mosque"] },
    { name: "Karwar", category: "OUTSTATION_GETAWAY", state: "KARNATAKA", description: "A naval base town where the Kali river meets the Arabian Sea, with quiet beaches along the Konkan coast.", distanceKm: 520, highlights: ["Kali river meeting the Arabian Sea", "Rabindranath Tagore Beach", "Gateway to Devbagh's coastal islands"] },
    { name: "Kanakapura", category: "OUTSTATION_GETAWAY", state: "KARNATAKA", description: "A riverside town near Sangama, the confluence of the Arkavathy and Kaveri rivers, and a base for nearby forest camps.", distanceKm: 60, highlights: ["Sangama — confluence of the Arkavathy and Kaveri rivers", "Doddamakali forest camp for coracle rides", "Route to the Male Mahadeshwara Hills pilgrimage circuit"] },
    { name: "Bhatkal", category: "OUTSTATION_GETAWAY", state: "KARNATAKA", description: "A historic medieval port town on the Konkan coast, close to Murudeshwar's giant Shiva statue.", distanceKm: 490, highlights: ["Historic medieval port on the Konkan coast", "Jain basadis and centuries-old mosques", "Close to Murudeshwar's giant Shiva statue"] },
  ];
